...
def draw_and_show(im, bboxes,ErrorPic,points=None):
    ...
    if num_boxes != 0:
        for i in range(num_boxes):
            ...
            if num_boxes>1:
                ...
                cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/pycaffe-mtcnn-master/PaperPic/Error'+str(ErrorPic)+'.jpg')
                ErrorPic=ErrorPic+1
    return ErrorPic
            #cv2.rectangle(im, (y1,x1), (y2,x2), (0,255,255), 2)
            ...
            #cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/WebFaceCropColor/'+FolderName+'/'+SinglePic,img)
...
def main():
    #cap=cv2.VideoCapture(0)
            ...
            EmptyPic=0
            ErrorPic=0
            Folder='/home/kjin/caffe-master/examples/VGGNet/Face/'
            ...
            for i in Pic_Dir:
                ...
                for SinglePic in SubListPic:
                    ...
                    if bboxes.shape[0] == 0:
                        cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/pycaffe-mtcnn-master/PaperPic/Empty' + str(EmptyPic) + '.jpg',im_bk)
                        cv2.imwrite('')
                        EmptyPic = EmptyPic + 1
                        #draw_and_show(im_bk, bboxes,FolderName,SinglePic)
                    ...
                    ErrorPic=draw_and_show(im_bk, bboxes,ErrorPic,points)
            return 0
