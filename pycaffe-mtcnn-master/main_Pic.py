...
def draw_and_show(im, bboxes ,SinglePic,points=None):
    ...
    if num_boxes != 0:
        for i in range(num_boxes):
            ...
            cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/DeepPic2/'+SinglePic,img)
...
def main():
    #cap=cv2.VideoCapture(0)
            ...
            Folder='/home/kjin/caffe-master/examples/VGGNet/DeepPic'
            Pic_Dir=os.listdir(Folder)  #Pic_Dir=10575
            #Num=len(Pic_Dir)

            for SinglePic in Pic_Dir:

                    im=cv2.imread('/home/kjin/caffe-master/examples/VGGNet/DeepPic/'+SinglePic)
                    im_bk = im.copy()
                    ...
                    if bboxes.shape[0] == 0:
                        draw_and_show(im_bk, bboxes,SinglePic)
                        continue
                    ...
                    if bboxes.shape[0] == 0:
                        draw_and_show(im_bk, bboxes,SinglePic,points)
                        continue
