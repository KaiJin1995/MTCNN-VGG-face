    ...
    if num_boxes != 0:
        for i in range(num_boxes):
           ...
           #           cv2.circle(im, (y,x), 1, (0,0,255), 2)
            #cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/pycaffe-mtcnn-master/selfie3.jpg', im)
            cv2.imwrite('/home/kjin/caffe-master/examples/VGGNet/pycaffe-mtcnn-master/'+str(num)+'.jpg', img)
            num=num+1
...
def main():
    #cap=cv2.VideoCapture(0)
            ...
            #assert im is not None, 'Image is empty.'
                ...
                for list in os.listdir('/home/kjin/caffe-master/tmp_delete/'):
                    im=cv2.imread('/home/kjin/caffe-master/tmp_delete/'+list)
                    im_bk = im.copy()
